...
import { getHomeFaqs } from "@/lib/data/localized";
...
const copy = {
  it: {
    ...
    title: "Le domande che ci fanno tutti gli imprenditori",
    intro:
  ...
  en: {
    ...
    intro:
      "Clear, jargon-free answers to the most common concerns about cybersecurity.",
  },
} as const;
